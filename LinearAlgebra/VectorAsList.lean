...
/-
  Here is an implementation of vectors as a subtype on lists, instead 
  of as pair types. 
  
  This implementation has the following advantages:

  (1) It allows for the use of the lengthy list API in our proofs.

  (2) It serparates the definition of functions on vectors in the 
      computational part, which operates on lists, and the reasoning 
      part, which pertains to demonstrating how the operation acts on 
